...
import biz.riman.erp.batch.service.delivery.JupiterDeliveryService;
...
public class JupiterDeliveryJob {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final JupiterDeliveryService service;
    private final DeliveryParameter parameter;

    public static final String JOB_NAME = "jupiter.deliveryBatch";

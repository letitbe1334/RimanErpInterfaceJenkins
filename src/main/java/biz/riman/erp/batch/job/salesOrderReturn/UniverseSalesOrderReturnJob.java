...
import biz.riman.erp.batch.service.salesOrderReturn.UniverseSalesOrderReturnService;
...
public class UniverseSalesOrderReturnJob {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final UniverseSalesOrderReturnService service;
    private final SalesOrderReturnParameter parameter;

    public static final String JOB_NAME = "universe.salesOrderReturnBatch";

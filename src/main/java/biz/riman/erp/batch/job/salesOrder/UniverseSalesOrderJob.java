package biz.riman.erp.batch.job.salesOrder;
...
import biz.riman.erp.batch.service.salesOrder.UniverseSalesOrderService;
...
public class UniverseSalesOrderJob {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final UniverseSalesOrderService service;
    private final SalesOrderParameter parameter;

    public static final String JOB_NAME = "uiverse.salesOrderBatch";
    ...
    public Step syncStep() throws Exception {
        ...
        return stepBuilderFactory.get(JOB_NAME + STEP_NAME)
                ...
                .tasklet((contribution, chunkContext) -> {
                    String response = service.callSalesOrder(parameter);

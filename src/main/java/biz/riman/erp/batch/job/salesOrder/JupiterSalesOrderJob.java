...
import biz.riman.erp.batch.service.salesOrder.JupiterSalesOrderService;
...
public class JupiterSalesOrderJob {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final JupiterSalesOrderService service;
    private final SalesOrderParameter parameter;

    public static final String JOB_NAME = "jupiter.salesOrderBatch";

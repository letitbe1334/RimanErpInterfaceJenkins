...
import biz.riman.erp.batch.service.businessPartner.BusinessPartnerCreateService;
...
public class BusinessPartnerCreateJob {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final BusinessPartnerCreateService service;
    private final BusinessPartnerParameter parameter;

    public static final String JOB_NAME = "universe.businessPartnerCreateBatch";
    ...
    public Step syncStep() throws Exception {
        ...
        return stepBuilderFactory.get(JOB_NAME + STEP_NAME)
                ...
                .tasklet((contribution, chunkContext) -> {
                    parameter.setSaveFlag("C");
                    String response = service.callBusinessPartnerCreate(parameter);

...
import biz.riman.erp.batch.service.salesOrderCancel.JupiterSalesOrderCancelService;
...
public class JupiterSalesOrderCancelJob {
    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;
    private final JupiterSalesOrderCancelService service;
    private final SalesOrderCancelParameter parameter;

    public static final String JOB_NAME = "jupiter.salesOrderCancelBatch";

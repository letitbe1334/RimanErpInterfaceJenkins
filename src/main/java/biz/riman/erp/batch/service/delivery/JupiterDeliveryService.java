...
import biz.riman.erp.batch.mapper.delivery.JupiterDeliveryMapper;
import biz.riman.erp.batch.parameter.DeliveryParameter;
import lombok.extern.slf4j.Slf4j;

@Slf4j
@Service
public class JupiterDeliveryService {
    @Autowired
    private JupiterDeliveryMapper mapper;
    @Autowired
    ...
    @Autowired
    public JupiterDeliveryService(@Qualifier("oAuth2WebClient") WebClient localApiClient) {

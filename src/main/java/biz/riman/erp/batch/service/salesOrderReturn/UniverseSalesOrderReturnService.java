...
import biz.riman.erp.batch.mapper.salesOrderReturn.UniverseSalesOrderReturnMapper;
import biz.riman.erp.batch.parameter.SalesOrderReturnParameter;
import lombok.extern.slf4j.Slf4j;

@Slf4j
@Service
public class UniverseSalesOrderReturnService {
    @Autowired
    private UniverseSalesOrderReturnMapper mapper;
    @Autowired
    ...
    @Autowired
    public UniverseSalesOrderReturnService(@Qualifier("oAuth2WebClient") WebClient localApiClient) {

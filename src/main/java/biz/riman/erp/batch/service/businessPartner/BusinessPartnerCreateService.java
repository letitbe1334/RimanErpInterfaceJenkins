...
@Slf4j
@Service
public class BusinessPartnerCreateService {
    @Autowired
    ...
    @Autowired
    public BusinessPartnerCreateService(@Qualifier("oAuth2WebClient") WebClient localApiClient) {
     ...
     * 
     * @param parameter
     * @return List<BusinessPartnerParamDto> 배치주기에 따른 BP생성 데이터 목록
     * @throws Exception
     */
    @Async
    ...
    public String callBusinessPartnerCreate(BusinessPartnerParameter parameter) throws Exception {
        String response = new String("");
        log.info("## BP 생성 I/F {} ~ {} ##", parameter.getStartDate(), parameter.getEndDate());
        log.info("");
...
//                    .exchangeToMono(clientResponse -> clientResponse.toEntity(String.class))
    ...
    public String callBusinessPartnerCreateDataTest(BusinessPartnerParameter parameter) throws Exception {
        String response = new String("");
        parameter.getMismatchStoreUniverse();
        log.info("## BP 생성 I/F {} ~ {} ##", parameter.getStartDate(), parameter.getEndDate());
        log.info("");

...
@SpringBootTest
public class JupiterDeliveryTest {
    @Autowired 
    ...
    public void test() {
        try {
            Job job = applicationContext.getBean(JupiterDeliveryJob.JOB_NAME, Job.class);
            ...
            jobParametersMap.put("job", new JobParameter("SyncJupiterDelivery"));

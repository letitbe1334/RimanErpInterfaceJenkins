...
import biz.riman.erp.batch.job.salesOrder.JupiterSalesOrderJob;
import lombok.extern.slf4j.Slf4j;

@Slf4j
@RunWith( SpringRunner.class )
@SpringBootTest
public class JupiterSalesOrderTest {
    @Autowired 
    ...
    public void test() {
        try {
            Job job = applicationContext.getBean(JupiterSalesOrderJob.JOB_NAME, Job.class);
